    ...
    public static void moveAllTraveler() {
        ...
        for(int i = 1; i <= m; i++) {
            ...
            if(traveler[i].x != exits.x) {
                int nx = traveler[i].x;
                int ny = traveler[i].y;
                System.out.println(traveler[i].x + "  " + traveler[i].y + " 행이동");
                if(exits.x > nx) nx++;
                else nx--;
            ...
            if(traveler[i].y != exits.y) {
                int nx = traveler[i].x;
                int ny = traveler[i].y;
                System.out.println(traveler[i].x + "  " + traveler[i].y + " 열이동");
                if(exits.y > ny) ny++;
                else ny--;
...
//                                System.out.println(traveler[l].x + " " + traveler[l].y + " : " + traveler.length);
                                for(Pair p : traveler){
                                    System.out.println(p.x + " " + p.y);
                                }
                                board[exits.x][exits.y] = -10;
                                isTravelerIn = true;
                            }
                        }
                    }
